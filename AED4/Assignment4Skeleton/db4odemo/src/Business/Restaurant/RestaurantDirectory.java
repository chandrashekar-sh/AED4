...
public class RestaurantDirectory {
    ...
    public Food AddMenuDishes(Restaurant restro,String name,String desc,String amount){
        menu=new Food(name, desc, amount);
        restro.addFoodItem(menu);
        return menu;
    }
    
    public void DeleteDishes(Restaurant restro,Food menu){
